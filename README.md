...
How It Works
Input: User provides text or records their voice.

Processing: Voice is transcribed via Whisper; text is smoothed and prepared.

Inference: The BERT model calculates "Logits."

Scaling: We apply a Sigmoid function with Temperature Scaling to convert raw AI confidence into a human-readable 0-100 score.

Feedback: * Level 1-2: Serious/Dry (Meme feedback).

Level 3: "Meh" (The awkward middle ground).

Level 4-5: Peak Comedy (Celebratory memes).
